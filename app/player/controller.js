...
module.exports = {
    ...
    checkOut: async (req, res) => {
        try {
            const { accountName, name, nominal, voucher, payment, bank } = req.body;
            ...
            const payload = {
                historyVoucher: {
                    ...
                    itemName: res_nominal._doc.itemName,
                    itemQuantity: res_nominal._doc.itemQuantity,
                ...
                historyPayment: {
                    ...
                    accountNum: res_bank._doc.accountNum,
                },
    ...
    editProfile: async (req, res) => {
        try {
            ...
            if (error && error.name === 'ValidationError') {
                return res.status(422).json({ error: 1, message: error.message, fields: error.errors });
            }
        }
    }
};